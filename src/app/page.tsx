...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-14">
      <section className="stars relative overflow-hidden rounded-[2rem] border-2 border-ink bg-header p-10 text-center shadow-[6px_6px_0_0_var(--color-ink)] sm:p-16">
        {/* cosmic decorations */}
        <span className="absolute -left-6 -top-6 h-24 w-24 rounded-full border-2 border-ink bg-highlight" />
        <span className="absolute right-10 top-10 text-4xl">🪐</span>
        <span className="absolute bottom-8 left-10 text-3xl">✨</span>
        <span className="absolute -bottom-8 right-8 h-20 w-20 rounded-full border-2 border-ink bg-accent1" />
        ...
        <div className="relative">
          ...
          <h1 className="mx-auto mt-5 max-w-2xl text-4xl font-bold leading-tight text-white drop-shadow-[2px_2px_0_var(--color-ink)] sm:text-6xl">
            ...
            <span className="text-primary"> from the stars</span>
          </h1>
